...
export const userAdminBaseUrl = import.meta.env.VITE_USER_ADMIN_BASE_URL ?? "https://dev.zoe-legal.net/api/user-admin";export const ONBOARDING_RETRY_DELAY_MS = 30_000;
