...
def get_user_properties(
    ...
    return fetch_user_properties(identity["internal_org_id"], identity["internal_user_id"])
...
def put_user_properties(
    ...
    identity = require_identity(x_internal_user_id, x_internal_org_id)
    apply_user_property_updates(identity["internal_org_id"], identity["internal_user_id"], payload)
    return fetch_user_properties(identity["internal_org_id"], identity["internal_user_id"])
...
def get_org_properties(
    ...
    identity = require_identity(x_internal_user_id, x_internal_org_id)
    ensure_owner(identity["internal_org_id"], identity["internal_user_id"])
    return fetch_org_properties(identity["internal_org_id"])
...
def put_org_properties(
    ...
    identity = require_identity(x_internal_user_id, x_internal_org_id)
    ensure_owner(identity["internal_org_id"], identity["internal_user_id"])
    apply_org_property_updates(identity["internal_org_id"], payload)
    return fetch_org_properties(identity["internal_org_id"])
...
def ensure_owner(internal_org_id: str, internal_user_id: str) -> None:
...
def fetch_user_properties(internal_org_id: str, internal_user_id: str) -> dict[str, Any]:
    with control_plane_connection() as conn:
        rows = conn.execute(
            """
            select
...
def fetch_org_properties(internal_org_id: str) -> dict[str, Any]:
    with control_plane_connection() as conn:
        rows = conn.execute(
            """
            select
...
def apply_user_property_updates(internal_org_id: str, internal_user_id: str, payload: dict[str, str | None]) -> None:
...
def apply_org_property_updates(internal_org_id: str, payload: dict[str, str | None]) -> None:
    updates = normalize_updates(payload)
    if not updates:
        return
